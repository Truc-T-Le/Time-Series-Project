...
par(mfrow=c(1,2))
#trend line 
{plot.ts(y^0.1,ylab="",main='Plot:Transformed and Trend')
points(tm,trend,type='l', col="purple")
legend(70,2.4, c("transformed","trend"), lty=c(1,1,2), col=c("black", "purple"))}

plot(Day,season,type='l',ylab='Seasonals',main='Seasonals for 1/y^0.1')
```

The next step after transforming the data using the optimal lambda value of 0.1, the trend and the seasonality components of the transformed dataset, $m_t$ and $s_t$, were estimated using the `trndseas()` function. As observed in the `Transformed and Trend` plot above, the estimated polynomial of degree 3 trend line fits the transformed data very well.  
